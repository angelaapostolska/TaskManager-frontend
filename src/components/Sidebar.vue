    ...
    <div class="profile-icon-wrapper">
      ...
      >
        <path
          ...
          d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 
      ...
      <div class="question-icon-wrapper">
        ...
        >
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
            d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 
                   1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 
...
<script setup>
// No script needed unless you want to make the sidebar dynamic
</script>

<style scoped>
/* Move your sidebar styles here */
.icons-column {
  position: fixed;
  top: 0;
  left: 0;
  ...
  align-items: center;
  background-image: url("../../public/sidebar-bg.png");
